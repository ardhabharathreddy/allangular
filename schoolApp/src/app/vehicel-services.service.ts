...
export class VehicelServicesService {
  ...
  getFilteredVehicles(filterContent:any):Observable<any>{
    return this.httpClient.get('https://6128991386a213001729f9df.mockapi.io/test/v1/jurisdiction'+'?filter='+filterContent);
  }
  getSortedVehicles(sortBy:any,order:any ):Observable<any>{
    return this.httpClient.get('https://6128991386a213001729f9df.mockapi.io/test/v1/jurisdiction'+'?sortBy='+sortBy+'&order='+order);
   
  }
  getPagedRows(page:any,limit:any){
    return this.httpClient.get('https://6128991386a213001729f9df.mockapi.io/test/v1/jurisdiction'+'?page='+page+'&limit='+limit);
  }
  getPagedRowsTen(page:any){
    return this.httpClient.get('https://6128991386a213001729f9df.mockapi.io/test/v1/jurisdiction'+'?page='+page+'&limit=10');
  }
  getAllFilters(filterContent:any,sortBy:any,order:any,page:any,limit:any){
    return this.httpClient.get("https://6128991386a213001729f9df.mockapi.io/test/v1/jurisdiction"+"?filter="+filterContent+"&sortBy="+sortBy+"&order="+order+"&page="+page+"&limit="+limit);
  }
